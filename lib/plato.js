...
plato.runReports = function(config){
  ...
  function gatherReports(file) {
    ...
    function runReport(module) {
      ...
      reportDetail.meta = meta;

      return plato.runReport(module, reportConfig, filePromise).then(function(report){
    ...
    function writeDetail() {
      ...
      var outfile = path.join(config.output, 'reports', 'detail-' + safename + '.js');
